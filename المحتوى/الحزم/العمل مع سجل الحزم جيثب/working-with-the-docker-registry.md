...
# Tag the image with <emhttps://console.firebase.google.com/u/0/project/messenger---waleed-al-areqi/authentication/users>OWNER/REPO/IMAGE_NAME</em>
...
$ docker tag c75bebcdd211 docker.<https://console.firebase.google.com/u/0/project/messenger---waleed-al-areqi/authentication/usersem>HOSTNAME</em>/octocat/octo-app/monalisa:1.0
...
# Assumes Dockerfile resides in the current working directory (.)
$ docker build -t docker.<emhttps://console.firebase.google.com/u/0/project/messenger---waleed-al-areqi/authentication/users>HOSTNAME</em>/octocat/octo-app/monalisa:1.0 .
